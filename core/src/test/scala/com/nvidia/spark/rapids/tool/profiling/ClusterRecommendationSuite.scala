...
import com.nvidia.spark.rapids.tool.tuning.{ProfilingAutoTunerHelper, ProfilingAutoTunerSuiteBase}
    ...
    TrampolineUtil.withTempDir { tempDir =>
      ...
      val expectedResults =
        s"""|
            ...
            |- ${ProfilingAutoTunerHelper.getEnforcedPropertyComment("spark.memory.offHeap.enabled")}
            |- ${ProfilingAutoTunerHelper.getEnforcedPropertyComment("spark.memory.offHeap.size")}
